...
BOOST_AUTO_TEST_CASE ( Hubbard_throw ) {

    Eigen::VectorXd triagonal_test_faulty(5);
    triagonal_test_faulty << 1, 2, 3, 4, 5;

    BOOST_CHECK_THROW(GQCP::HamiltonianParameters::Hubbard(triagonal_test_faulty), std::invalid_argument);
}
...
BOOST_AUTO_TEST_CASE ( hubbard_upperTriagonal ) {
    ...
    auto hubbard_ham_par = GQCP::HamiltonianParameters::Hubbard(triagonal_test);
