...
BOOST_AUTO_TEST_CASE ( FockSpace_EvaluateOperator_Dense_diagonal_true ) {
    ...
    GQCP::ProductFockSpace product_fock_space(6, 4, 0);  // 4 alpha 0 beta product Fock space as selected Fock space constructor will mimic a spin orbital or doubly occupied Fock space
