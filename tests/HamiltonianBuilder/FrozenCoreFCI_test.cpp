...
BOOST_AUTO_TEST_CASE ( SelectedCI_vs_FrozenCoreFCI ) {
    ...
    Eigen::VectorXd fci_diagonal = random_fci.calculateDiagonal(random_hamiltonian_parameters);

    Eigen::VectorXd sci_matvec = random_sci.matrixVectorProduct(random_hamiltonian_parameters, sx, sx);
    Eigen::VectorXd fci_matvec = random_fci.matrixVectorProduct(random_hamiltonian_parameters, fx, fx);

    Eigen::MatrixXd sci_ham = random_sci.constructHamiltonian(random_hamiltonian_parameters);
    Eigen::MatrixXd fci_ham = random_fci.constructHamiltonian(random_hamiltonian_parameters);
