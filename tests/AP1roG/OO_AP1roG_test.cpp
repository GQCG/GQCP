...
BOOST_AUTO_TEST_CASE ( constructor ) {
    ...
    GQCG::AP1roGJacobiOrbitalOptimizer ap1rog_orbital_optimizer (N, mol_ham_par);


    // Test a faulty constructor
    size_t N_ion = 1;  // number of electrons for cationic H2
    BOOST_CHECK_THROW(GQCG::AP1roGJacobiOrbitalOptimizer(N_ion, mol_ham_par), std::invalid_argument);  // we can use the same Hamiltonian parameters for molecule and ion
}
