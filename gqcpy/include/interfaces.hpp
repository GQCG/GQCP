 ...
 */
template <typename Class>
void bindSimpleSQOneElectronOperatorMullikenInterface(Class& py_class) {
...
void bindSimpleSQOneElectronOperatorInterface(Class& py_class) {
    ...
    bindSimpleSQOneElectronOperatorMullikenInterface(py_class);
}
 ...
 *  @tparam Class               The type of the Pybind11 `class_` (generated by the compiler).
 *  
 *  @param py_class             The Pybind11 `class_` that should obtain acess bindings like a scalar two-electron operator.
 */
template <typename Class>
