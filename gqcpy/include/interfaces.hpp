...
/**
 *  Add Python bindings for `SpinResolved` transformations C++ interface to a given `pybind11::class_`.
 * 
 *  @tparam Class               The type of the Pybind11 `class_` (generated by the compiler).
 *  
 *  @param py_class             The Pybind11 `class_` that should obtain `SpinResolved` transformation's APIs.
 */
template <typename Class>
void bindSpinResolvedTransformationInterface(Class& py_class) {
    ...
    py_class
        ...
        .def(
            "isUnitary",
            [](const Type& object, const double treshold) {
                object.isUnitary(treshold);
            },
