...
/**
 *  Add Python bindings for some APIs related to `RSpinOrbitalBasis` over `GTOShell`s.
 *
...
void bindGTORSpinOrbitalBasisInterface(Class& py_class) {
...
void bindRSpinOrbitalBases(py::module& module) {
    ...
    bindGTORSpinOrbitalBasisInterface(py_RSpinOrbitalBasis_d);
    ...
    bindGTORSpinOrbitalBasisInterface(py_RSpinOrbitalBasis_cd);
    ...
    // Define the Python class for `LondonRSpinOrbitalBasis`.
    py::class_<RSpinOrbitalBasis<complex, LondonGTOShell>> py_LondonRSpinOrbitalBasis {module, "LondonRSpinOrbitalBasis", "A class that represents a complex, restricted spin-orbital basis with underlying London GTO shells."};

    py_LondonRSpinOrbitalBasis
        .def(
            "quantize",
