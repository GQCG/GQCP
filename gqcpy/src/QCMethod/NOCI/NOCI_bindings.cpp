...
void bindQCMethodCI(py::module& module) {
    ...
    py::class_<QCMethod::CI<double, GNonOrthogonalStateBasis<double>>> py_CI_d_GNonOrthogonalStateBasis {module, "CI_d_GNonOrthogonalStateBasis", "Real-valued non-orthogonal configuration interaction in a basis that consists of 'generalized' states."};
    bindQCMethodNOCIInterface(py_CI_d_GNonOrthogonalStateBasis);

    py::class_<QCMethod::CI<double, RNonOrthogonalStateBasis<double>>> py_CI_d_RNonOrthogonalStateBasis {module, "CI_d_RNonOrthogonalStateBasis", "Real-valued non-orthogonal configuration interaction in a basis that consists of 'restricted' states."};
    bindQCMethodNOCIInterface(py_CI_d_RNonOrthogonalStateBasis);

    py::class_<QCMethod::CI<double, UNonOrthogonalStateBasis<double>>> py_CI_d_UNonOrthogonalStateBasis {module, "CI_d_UNonOrthogonalStateBasis", "Real-valued non-orthogonal configuration interaction in a basis that consists of 'unrestricted' states."};
    bindQCMethodNOCIInterface(py_CI_d_UNonOrthogonalStateBasis);

    py::class_<QCMethod::CI<complex, GNonOrthogonalStateBasis<complex>>> py_CI_cd_GNonOrthogonalStateBasis {module, "CI_cd_GNonOrthogonalStateBasis", "Complex-valued non-orthogonal configuration interaction in a basis that consists of 'generalized' states."};
    bindQCMethodNOCIInterface(py_CI_cd_GNonOrthogonalStateBasis);

    py::class_<QCMethod::CI<complex, RNonOrthogonalStateBasis<complex>>> py_CI_cd_RNonOrthogonalStateBasis {module, "CI_cd_RNonOrthogonalStateBasis", "Complex-valued non-orthogonal configuration interaction in a basis that consists of 'restricted' states."};
    bindQCMethodNOCIInterface(py_CI_cd_RNonOrthogonalStateBasis);

    py::class_<QCMethod::CI<complex, UNonOrthogonalStateBasis<complex>>> py_CI_cd_UNonOrthogonalStateBasis {module, "CI_cd_UNonOrthogonalStateBasis", "Complex-valued non-orthogonal configuration interaction in a basis that consists of 'unrestricted' states."};
