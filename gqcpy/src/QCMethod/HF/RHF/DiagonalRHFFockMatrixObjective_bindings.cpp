...
/**
 *  Add Python bindings for some APIs related to RHF SCF objectives.
 * 
 *  @tparam Class               The type of the Pybind11 `class_` (generated by the compiler).
 *  
 *  @param py_class             The Pybind11 `class_` that should obtain APIs related to RHF SCF objectives.
 */
template <typename Class>
void bindRHFSCFObjectiveInterface(Class& py_class) {
    ...
    py_class
        ...
        .def(py::init<const RSQHamiltonian<Scalar>&, const double>(),
...
/**
 *  Add Python bindings for RHF Objectives.
 */
