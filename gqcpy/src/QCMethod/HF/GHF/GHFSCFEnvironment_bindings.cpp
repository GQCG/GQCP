...
void bindQCModelGHFSCFEnvironmentInterface(Class& py_class) {
    ...
    py_class
        ...
        .def_static(
            "WithCoreGuess",
            [](const size_t N, const GSQHamiltonian<Scalar>& hamiltonian, const Eigen::Matrix<Scalar, Eigen::Dynamic, Eigen::Dynamic>& S) {
        ...
        .def_property(
            ...
            [](GHFSCFEnvironment<Scalar>& environment, const Eigen::Matrix<Scalar, Eigen::Dynamic, Eigen::Dynamic>& S) {
                // Use an itermediary Eigen matrix for the Python binding, since Pybind11 doesn't accept our types that are derived from Eigen::Matrix.
                environment.S = SquareMatrix<Scalar>(S);
            })
