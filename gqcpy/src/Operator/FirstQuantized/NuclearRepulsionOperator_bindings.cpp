...
/**
 *  Register `NuclearRepulsionOperator` to the gqcpy module and expose parts of its C++ interface to Python.
 * 
...
void bindNuclearRepulsionOperator(py::module& module) {
    ...
    py::class_<NuclearRepulsionOperator> py_NuclearRepulsionOperator {module, "NuclearRepulsionOperator", "The nuclear repulsion operator."};

    py_NuclearRepulsionOperator
