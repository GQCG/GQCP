...
void bindvAP1roGElectricalResponseSolver(py::module& module) {
    ...
    py::class_<GQCP::vAP1roGElectricalResponseSolver>(module, "vAP1roGElectricalResponseSolver", "A class whose instances can solve the response equations for vAP1roG.")
        ...
        .def(
            ...
            [](const GQCP::vAP1roGElectricalResponseSolver& response_solver, const GQCP::RSQHamiltonian<double>& sq_hamiltonian, const GQCP::VectorSQOneElectronOperator<double>& dipole_op) {
        ...
        .def(
            ...
            [](const GQCP::vAP1roGElectricalResponseSolver& response_solver, const GQCP::RSQHamiltonian<double>& sq_hamiltonian, const GQCP::VectorSQOneElectronOperator<double>& dipole_op, const Eigen::Matrix<double, Eigen::Dynamic, 3>& x) {
