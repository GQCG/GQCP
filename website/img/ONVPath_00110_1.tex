...
% draw nodes
\foreach \i in {0,...,3} {
    \node[circle, draw=black, fill=black] (i-\i) at (\i, -\i) {};
    \node[circle, draw=black, fill=black] (j-\i) at (\i, -\i-1) {};
    \node[circle, draw=black, fill=black] (k-\i) at (\i, -\i-2) {};
}
...
\node[circle, draw=blue, fill=blue] at (0, -1) {};
