...
public:
    ...
    /*
    // PUBLIC METHODS - ATOMIC DECOMPOSITION
    template<typename Z = Scalar>
    enable_if_t<std::is_same<Z, double>::value, AtomicDecompositionParameters<double>> atomicDecomposition() const {
    ...
    */
    ...
    /*
    template<typename Z = Scalar>
    enable_if_t<std::is_same<Z, double>::value, AtomicDecompositionParameters<double>> atomicDecomposition2() const {
        ...
        g_b.fourModeMultiplication(p_b, SquareMatrix::Identiy(this->K, this->K), p_b, SquareMatrix::Identiy(this->K, this->K));
        g_ab.fourModeMultiplication(p_a, SquareMatrix::Identiy(this->K, this->K), p_b, SquareMatrix::Identiy(this->K, this->K));
        g_ba.fourModeMultiplication(p_b, SquareMatrix::Identiy(this->K, this->K), p_a, SquareMatrix::Identiy(this->K, this->K));
        g_abba = g_ab + g_ba;

        HamiltonianParameters<double> HAA(this->ao_basis, ham_par.get_S(), h_a, g_a, SquareMatrix::Identiy(this->K, this->K));
        HamiltonianParameters<double> HBB(this->ao_basis, ham_par.get_S(), h_b, g_b, SquareMatrix::Identiy(this->K, this->K));
        HamiltonianParameters<double> HAB(this->ao_basis, ham_par.get_S(), h_ab, g_abba, SquareMatrix::Identiy(this->K, this->K));
        HamiltonianParameters<double> HA(this->ao_basis, ham_par.get_S(), h_a + h_ab/2, g_a + g_abba/2, SquareMatrix::Identiy(this->K, this->K));
        HamiltonianParameters<double> HB(this->ao_basis, ham_par.get_S(), h_b + h_ab/2, g_b + g_abba/2, SquareMatrix::Identiy(this->K, this->K));


        return AtomicDecompositionParameters
