...
private:
    ...
    std::deque<SQOneElectronOperator<double>> fock_matrix_deque = {};  // deque of Fock matrices used in the DIIS algorithm
    std::deque<SQOneElectronOperator<double>> error_matrix_deque = {};  // deque of error matrices used in the DIIS algorithm
