...
protected:
    ...
    RSpinorBasis<double, GTOShell> sp_basis;  // the single-particle basis (AOs)
...
public:
     ...
     */
    RHFSCFSolver(const SQHamiltonian<double>& sq_hamiltonian, const RSpinorBasis<double, GTOShell>& sp_basis, const Molecule& molecule, double threshold=1.0e-08, size_t maximum_number_of_iterations=128);
