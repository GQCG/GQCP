...
public:
     ...
     */
    BaseAP1roGSolver(size_t N_P, const SQHamiltonian<double>& ham_par, const AP1roGGeminalCoefficients& G, const double convergence_threshold = 1.0e-08, const size_t maximum_number_of_iterations = 128);
     ...
     */
    BaseAP1roGSolver(size_t N_P, const SQHamiltonian<double>& ham_par, const double convergence_threshold = 1.0e-08, const size_t maximum_number_of_iterations = 128);
     ...
     *  @param maximum_number_of_iterations         the maximum number of Newton steps that may be used to achieve convergence of the PSEs
     */
    BaseAP1roGSolver(const Molecule& molecule, const SQHamiltonian<double>& ham_par, const AP1roGGeminalCoefficients& G, const double convergence_threshold = 1.0e-08, const size_t maximum_number_of_iterations = 128);
     ...
     *  The initial guess for the geminal coefficients is zero
     */
    BaseAP1roGSolver(const Molecule& molecule, const SQHamiltonian<double>& ham_par, const double convergence_threshold = 1.0e-08, const size_t maximum_number_of_iterations = 128);
    ...
    const SQHamiltonian<double>& get_ham_par() const { return this->ham_par; }
