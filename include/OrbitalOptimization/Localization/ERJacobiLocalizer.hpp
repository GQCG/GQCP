...
public:
     ...
     */
    void calculateJacobiCoefficients(const SQHamiltonian<double>& ham_par, const size_t i, const size_t j) override;
     ...
     */
    double calculateOptimalRotationAngle(const SQHamiltonian<double>& ham_par, const size_t i, const size_t j) const override;
