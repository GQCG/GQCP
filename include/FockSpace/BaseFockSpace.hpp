...
public:
     ...
     */
    virtual SquareMatrix<double> evaluateOperatorDense(const SQOneElectronOperator<double>& one_op, bool diagonal_values) const = 0;
     ...
     */
    virtual Eigen::SparseMatrix<double> evaluateOperatorSparse(const SQOneElectronOperator<double>& one_op,
     ...
     *  @return the operator's evaluation in a dense matrix with the dimensions of the Fock space
     */
    virtual SquareMatrix<double> evaluateOperatorDense(const SQTwoElectronOperator<double>& two_op, bool diagonal_values) const = 0;
     ...
     *  @return the operator's evaluation in a sparse matrix with the dimensions of the Fock space
     */
    virtual Eigen::SparseMatrix<double> evaluateOperatorSparse(const SQTwoElectronOperator<double>& two_op,
                                                               bool diagonal_values) const = 0;
     ...
     */
    virtual VectorX<double> evaluateOperatorDiagonal(const SQOneElectronOperator<double>& one_op) const = 0;
     ...
     *  @return the operator's diagonal evaluation in a vector with the dimension of the Fock space
     */
    virtual VectorX<double> evaluateOperatorDiagonal(const SQTwoElectronOperator<double>& two_op) const = 0;
