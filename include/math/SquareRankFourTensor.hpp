...
public:
    ...
    /**
     *  @return the a pair-wise reduction of this square rank-4 tensor, i.e. the tensor analog of a strict "lower triangle" as a matrix in column major form
     *
    ...
    /**
     *  Add a matrix to a target tensor starting from given indices
     *
    ...
    Self& addBlock(const MatrixX<Scalar>& M, size_t i, size_t j, size_t k, size_t l) {
    ...
    using Base::addBlock;  // Base also has an addBlock, so bring it over because we overload it here
};
