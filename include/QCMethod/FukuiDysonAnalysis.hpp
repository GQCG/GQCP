...
/**
 *  A class that solves the FCI Hamiltonian for a given singlet molecule and performs Fukui and Dyson analysis
...
public:
     ...
     */
    FukuiDysonAnalysis(const Molecule& molecule, const std::string& basis_set);
