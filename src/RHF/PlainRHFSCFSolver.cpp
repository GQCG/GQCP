 ...
 */
PlainRHFSCFSolver::PlainRHFSCFSolver(const SQHamiltonian<double>& sq_hamiltonian, const Molecule& molecule, double threshold, size_t maximum_number_of_iterations) :
