 ...
 */
VectorX<double> AP1roGPSEs::calculateCoordinateFunctions(const AP1roGGeminalCoefficients& G) const {
...
VectorFunction AP1roGPSEs::callableCoordinateFunctions() const {
    ...
    const VectorFunction callable = [this] (const VectorX<double>& x) {  // requires a row-major vector as input
 ...
 */
double AP1roGPSEs::calculateJacobianElement(const AP1roGGeminalCoefficients& G, const size_t j, const size_t b, const size_t i, const size_t a) const {
 ...
 */
SquareMatrix<double> AP1roGPSEs::calculateJacobian(const AP1roGGeminalCoefficients& G) const {
...
MatrixFunction AP1roGPSEs::callableJacobian() const {
    ...
    const MatrixFunction callable = [this](const VectorX<double>& x) {  // requires a row-major vector as input
        const auto G = AP1roGGeminalCoefficients::FromRowMajor(x, this->N_P, this->K);
