    ...
    BaseAP1roGSolver(molecule.get_N()/2, ham_par, G)
{
    ...
    if ((molecule.get_N() % 2) != 0) {
        throw std::invalid_argument("BaseAP1roGSolver::BaseAP1roGSolver(Molecule, const HamiltonianParameters<double>, const AP1roGGeminalCoefficients): The given number of electrons is odd.");
    }
}
