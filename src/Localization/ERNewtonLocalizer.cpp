 ...
 */
double ERNewtonLocalizer::calculateGradientElement(const GQCP::HamiltonianParameters& ham_par, size_t i, size_t j) const {
 ...
 */
Eigen::MatrixXd ERNewtonLocalizer::calculateGradient(const GQCP::HamiltonianParameters& ham_par) const {
 ...
 */
double ERNewtonLocalizer::calculateHessianElement(const GQCP::HamiltonianParameters& ham_par, size_t i, size_t j, size_t k, size_t l) const {
 ...
 */
Eigen::Tensor<double, 4> ERNewtonLocalizer::calculateHessian(const GQCP::HamiltonianParameters& ham_par) const {
