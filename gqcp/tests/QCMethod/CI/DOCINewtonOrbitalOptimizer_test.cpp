...
BOOST_AUTO_TEST_CASE ( OO_DOCI_h2_sto_3g ) {
    ...
    GQCP::ONVBasis fock_space (K, h2.numberOfElectrons()/2);  // dim = 120
...
BOOST_AUTO_TEST_CASE ( OO_DOCI_h2_6_31g ) {
    ...
    GQCP::ProductONVBasis fci_fock_space (K, N_a, N_b);  // dim = 441
    ...
    GQCP::ONVBasis doci_fock_space (K, h2.numberOfElectrons()/2);  // dim = 120
