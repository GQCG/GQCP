...
BOOST_AUTO_TEST_CASE(DOCI_BeH_cation_dense) {
    ...
    const auto sq_hamiltonian = GQCP::SQHamiltonian<double>::ReadFCIDUMP("data/beh_cation_631g_caitlin.FCIDUMP");
...
BOOST_AUTO_TEST_CASE(DOCI_LiH_dense) {
    ...
    // Read in the molecular Hamiltonian from a FCIDUMP file.
    const auto sq_hamiltonian = GQCP::SQHamiltonian<double>::ReadFCIDUMP("data/lih_631g_caitlin.FCIDUMP");
    const auto K = sq_hamiltonian.dimension();  // the number of spatial orbitals
...
BOOST_AUTO_TEST_CASE(DOCI_Li2_dense) {
    ...
    // Read in the molecular Hamiltonian from a FCIDUMP file.
    const auto sq_hamiltonian = GQCP::SQHamiltonian<double>::ReadFCIDUMP("data/li2_321g_klaas.FCIDUMP");
    const auto K = sq_hamiltonian.dimension();  // the number of spatial orbitals
...
BOOST_AUTO_TEST_CASE(DOCI_h2o_sto3g_Davidson) {
    ...
    // Read in the molecular Hamiltonian from a FCIDUMP file.
    const auto sq_hamiltonian = GQCP::SQHamiltonian<double>::ReadFCIDUMP("data/h2o_sto3g_klaas.FCIDUMP");
    const auto K = sq_hamiltonian.dimension();  // the number of spatial orbitals
...
BOOST_AUTO_TEST_CASE(DOCI_N2_STO_3G_Davidson) {
    ...
    // Read in the molecular Hamiltonian from a FCIDUMP file.
    const auto sq_hamiltonian = GQCP::SQHamiltonian<double>::ReadFCIDUMP("data/n2_sto-3g_klaas.FCIDUMP");
    const auto K = sq_hamiltonian.dimension();  // the number of spatial orbitals
...
BOOST_AUTO_TEST_CASE(DOCI_H2O_6_31G_Davidson) {
    ...
    // Read in the molecular Hamiltonian from a FCIDUMP file.
    const auto sq_hamiltonian = GQCP::SQHamiltonian<double>::ReadFCIDUMP("data/h2o_631g_klaas.FCIDUMP");
    const auto K = sq_hamiltonian.dimension();  // the number of spatial orbitals
