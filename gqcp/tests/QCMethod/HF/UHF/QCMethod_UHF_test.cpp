...
BOOST_AUTO_TEST_CASE(h2o_sto3g_plain) {
    ...
    BOOST_CHECK(GQCP::VectorX<double>::areEqualEigenvalues(ref_orbital_energies, uhf_environment.orbital_energies_alpha.back(), 1.0e-06));
    BOOST_CHECK(GQCP::VectorX<double>::areEqualEigenvalues(ref_orbital_energies, uhf_environment.orbital_energies_beta.back(), 1.0e-06));

    BOOST_CHECK(GQCP::MatrixX<double>::areEqualSetsOfEigenvectors(ref_C, uhf_environment.coefficient_matrices_alpha.back(), 1.0e-05));
    BOOST_CHECK(GQCP::MatrixX<double>::areEqualSetsOfEigenvectors(ref_C, uhf_environment.coefficient_matrices_beta.back(), 1.0e-05));
}
