...
BOOST_AUTO_TEST_CASE ( simple_dense ) {
    ...
    GQCP::VectorX<double> ref_lowest_eigenvector = self_adjoint_eigensolver.eigenvectors().col(0);
    ...
    GQCP::VectorX<double> test_lowest_eigenvector = dense_solver.get_eigenvector();
