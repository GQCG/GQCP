...
/**
 *  In this test we iterate over the entire Fock space using the ONVBasis::setNextONV(ONV&) 
...
BOOST_AUTO_TEST_CASE ( ONVBasis_EvaluateOperator_Dense_diagonal_true ) {
    ...
    GQCP::ProductONVBasis product_fock_space (6, 4, 0);  // 4 alpha 0 beta product Fock space as selected Fock space constructor argument will mimic a spin orbital Fock space
