...
/**
 *  Test if the expansions generated by the SpinUnresolvedONV basis are normalized.
 */
...
BOOST_AUTO_TEST_CASE ( vertex_weights_K5_N3 ) {
    ...
    GQCP::SpinUnresolvedONVBasis fock_space = GQCP::SpinUnresolvedONVBasis(5, 3);
...
/**
 *  Test if the SpinUnresolvedONV basis correctly counts the amount of coupling ONVs with larger address for a given SpinUnresolvedONV
 */
