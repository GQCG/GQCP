...
BOOST_AUTO_TEST_CASE(calculateEdmistonRuedenbergLocalizationIndex) {
    ...
    const auto orbital_space1 = GQCP::OrbitalSpace::Occupied(3);  // 3 occupied spatial orbitals
    const auto orbital_space2 = GQCP::OrbitalSpace::Occupied(4);  // 3 occupied spatial orbitals
