...
BOOST_AUTO_TEST_CASE(USQHamiltonian_constructor) {
    ...
    const GQCP::RSQHamiltonian<double> sq_hamiltonian_a {GQCP::ScalarSQOneElectronOperator<double>(H_core), GQCP::ScalarSQTwoElectronOperator<double>(g)};
    const GQCP::RSQHamiltonian<double> sq_hamiltonian_b {GQCP::ScalarSQOneElectronOperator<double>(H_core), GQCP::ScalarSQTwoElectronOperator<double>(g)};
    const GQCP::RSQHamiltonian<double> sq_hamiltonian_b_faulty {GQCP::ScalarSQOneElectronOperator<double>(H_core_faulty), GQCP::ScalarSQTwoElectronOperator<double>(g_faulty)};
