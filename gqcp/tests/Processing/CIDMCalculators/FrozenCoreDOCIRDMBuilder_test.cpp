...
BOOST_AUTO_TEST_CASE(FrozenCoreDOCI_one_DMs) {
    ...
    GQCP::SpinResolvedOneDM<double> one_DMs_s = sci_rdm.calculateSpinResolved1DM(coef);
    GQCP::SpinResolvedOneDM<double> one_DMs = doci_rdm.calculateSpinResolved1DM(coef);
