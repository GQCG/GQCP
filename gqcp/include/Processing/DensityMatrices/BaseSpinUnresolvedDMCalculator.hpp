...
/**
 *  BaseSpinUnresolvedDMCalculator is an abstract base class whose derived classes are capable of calculating 1- and 2-RDM from wave functions in a spin unresolved basis
 */
...
public:
     ...
     */
    virtual OneDM<double> calculate1RDM(const VectorX<double>& x) const = 0;
     ...
     */
    virtual TwoDM<double> calculate2RDM(const VectorX<double>& x) const = 0;
