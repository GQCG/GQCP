...
public:
     ...
     */
    Matrix<double, Dynamic, 3> calculateWaveFunctionResponse(const RSQHamiltonian<double>& sq_hamiltonian, const VectorSQOneElectronOperator<double> dipole_op) const;
};
