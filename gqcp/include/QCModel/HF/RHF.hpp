...
public:
     ...
     */
    static Field<Matrix<complex, 3, 3>> calculateIpsocentricMagneticInducibility(const CubicGrid& grid, const OrbitalSpace& orbital_space, const Matrix<complex, Dynamic, 3>& x_B, const Matrix<complex, Dynamic, 3>& x_G, const VectorRSQOneElectronOperator<complex>& j_op) {
