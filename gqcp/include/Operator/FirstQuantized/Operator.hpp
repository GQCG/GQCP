...
public:
     ...
     */
    static ElectronicDipoleOperator ElectronicDipole(const Vector<double, 3>& o = Vector<double, 3>::Zero()) { return ElectronicDipoleOperator(o); }
     ...
     */
    static NuclearDipoleOperator NuclearDipole(const Molecule& molecule, const Vector<double, 3>& o = Vector<double, 3>::Zero()) { return NuclearDipoleOperator(molecule.nuclearFramework(), o); }
