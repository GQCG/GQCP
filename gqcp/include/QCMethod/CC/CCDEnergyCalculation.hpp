...
/**
 *  An iteration step that calculates the current CCD electronic correlation energy.
 * 
...
public:
    ...
    std::string description() const override {
        return "Calculate the current CCD electronic correlation energy.";
    }

    /**
     *  Calculate the current CCD electronic correlation energy.
     * 
