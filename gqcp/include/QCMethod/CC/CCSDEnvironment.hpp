...
public:
     ...
     */
    static CCSDEnvironment<Scalar> PerturbativeCCSD(const RSQHamiltonian<Scalar>& sq_hamiltonian, const OrbitalSpace& orbital_space) {
     ...
     */
    static CCSDEnvironment<Scalar> PerturbativeCCD(const RSQHamiltonian<Scalar>& sq_hamiltonian, const OrbitalSpace& orbital_space) {
