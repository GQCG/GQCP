...
public:
    ...
    QCStructure<GQCP::QCModel::CCSD<Scalar>, Scalar> optimize(Solver& solver, CCSDEnvironment<Scalar>& environment) const {
        ...
        return QCStructure<GQCP::QCModel::CCSD<Scalar>, Scalar>({E_electronic_correlation}, {ccsd_parameters});
    }
};
