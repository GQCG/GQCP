...
#include "QCMethod/CC/LambdaCCSDEnvironment.hpp"
#include "QCMethod/QCStructure.hpp"
#include "QCModel/CC/LambdaCCSD.hpp"
...
/**
 *  The Lambda-CCSD quantum chemical method.
 * 
...
class LambdaCCSD {
public:
    // The scalar type used to represent the T1- and T2-amplitudes.
...
public:
    ...
    /**
     *  Optimize the Lambda-CCSD wave function model.
     * 
    ...
    // QCStructure<GQCP::QCModel::LambdaCCSD<Scalar>> optimize(Solver& solver, LambdaCCSDEnvironment<Scalar>& environment) const {

    //     // The LambdaCCSD method's responsibility is to try to optimize the parameters of its method, given a solver and associated environment.
    ...
    //     const QCModel::LambdaCCSD<Scalar> LambdaCCSD_parameters {T1, T2};

    //     return QCStructure<GQCP::QCModel::LambdaCCSD<Scalar>>({E_electronic_correlation}, {LambdaCCSD_parameters});
    // }
};
