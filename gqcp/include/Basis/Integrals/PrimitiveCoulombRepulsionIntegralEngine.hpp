...
public:
    ...
    static constexpr auto Components = CoulombRepulsionOperator::NumberOfComponents;
...
public:
     ...
     * 
     *  @note Since the Coulomb repulsion operator has only 1 component, this method has no effect.
     */
