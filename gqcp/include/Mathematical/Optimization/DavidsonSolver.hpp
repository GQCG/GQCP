...
public:
     ...
     */
    DavidsonSolver(const VectorFunction& matrixVectorProduct, const VectorX<double>& diagonal, const DavidsonSolverOptions& davidson_solver_options);
