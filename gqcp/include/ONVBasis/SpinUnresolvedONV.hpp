...
public:
     ...
     */
    size_t get_occupation_index(size_t electron_index) const { return occupationIndexOf(electron_index); }
     ...
     *  
     *  @return the occupation index of the given electron (index)
     */
