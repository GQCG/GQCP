 ...
 */
double SpinResolvedONV::calculateProjection(const SpinResolvedONV& onv_on, const UTransformationMatrix<double>& C_unrestricted, const TransformationMatrix<double>& C_restricted, const SquareMatrix<double>& S) const {
