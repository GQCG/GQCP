 ...
 */
RHFOld::RHFOld() :
    RHFOld(0.0, TransformationMatrix<double>::Zero(0, 0), VectorX<double>::Zero(0))
{}
 ...
 */
RHFOld::RHFOld(double electronic_energy, const TransformationMatrix<double>& C, const VectorX<double>& orbital_energies) :
