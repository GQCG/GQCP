...
if(MKL_FOUND AND NOT TARGET MKL::MKL)
    ...
    if(NOT APPLE)
        target_link_libraries(MKL::MKL INTERFACE  -Wl,-Bstatic -Wl,--start-group mkl_intel_lp64 mkl_intel_thread mkl_core -Wl,--end-group -Wl,-Bdynamic iomp5 pthread m dl)
    else()
