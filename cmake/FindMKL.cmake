...
find_library(MKL_INTERFACE_LIBRARY NAMES libmkl_intel_lp64.so ibmkl_intel_lp64.dylib PATHS $ENV{MKLROOT}/lib $ENV{MKLROOT}/lib/intel64)
...
if(MKL_FOUND AND NOT TARGET MKL::MKL)
    ...
    if(NOT APPLE)
        target_link_libraries(MKL::MKL INTERFACE  -Wl,--no-as-needed ${MKL_INTERFACE_LIBRARY} ${MKL_INTEL_THREAD} ${MKL_CORE_LIBRARY} ${MKL_IOMP5} pthread m dl)
    else()
